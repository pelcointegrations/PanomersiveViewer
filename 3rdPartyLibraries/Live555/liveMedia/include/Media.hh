...
public:
  static Boolean lookupByName(UsageEnvironment& env,
			      ...
			      Medium*& resultMedium);
  __declspec(dllexport) static void close(UsageEnvironment& env, char const* mediumName);
  __declspec(dllexport) static void close(Medium* medium); // alternative close() method using ptrs
  ...
  __declspec(dllexport) virtual Boolean isSource() const;
  __declspec(dllexport) virtual Boolean isSink() const;
  __declspec(dllexport) virtual Boolean isRTCPInstance() const;
  __declspec(dllexport) virtual Boolean isRTSPClient() const;
  __declspec(dllexport) virtual Boolean isRTSPServer() const;
  __declspec(dllexport) virtual Boolean isMediaSession() const;
  __declspec(dllexport) virtual Boolean isServerMediaSession() const;
