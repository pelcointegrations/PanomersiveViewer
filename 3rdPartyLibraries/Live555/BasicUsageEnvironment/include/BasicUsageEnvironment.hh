...
public:
    __declspec(dllexport) static BasicUsageEnvironment* createNew(TaskScheduler& taskScheduler);
...
public:
  __declspec(dllexport) static BasicTaskScheduler* createNew(unsigned maxSchedulerGranularity = 10000/*microseconds*/);
